  ...
  <div id="product_mark">
    ...
    <div style="background-color:#fff; padding:30px;  border: thick solid #a5a7da" class="col-sm-12">
      ...
      <div style="text-align: center; padding-top: 10px;" class="row">
           <a style="text-align: center" href="<?php echo $cart; ?>"><button style="display:inherit;background-color:#a5a7da; width:70%; margin:auto" class="btn btn-primary">View Cart</button></a>
       </div>
