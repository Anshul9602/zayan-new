         ...
         <div class="row">
            ...
            <div class="col-6 col-sm-3 d-flex justify-content-end">
               ...
               <select style="margin-top: 20px;" id="input-sort" class="form-control sort">
                                                                        ...
                                                                        <option value="p_ASC">MSRP (Low &gt; High)</option>
                                                                      <option value="p_DESC">MSRP (High &gt; Low)</option>
                                                               </select>
               </div>
...
<script src="catalog/view/javascript/filters.js?v=1.12095"></script>

<script>
   //fetch products and show array
   var temp = <?php echo json_encode(isset($products) ? $products : array()); ?>;
   if (!Array.isArray(temp)) {
      temp = [];
   }
   var items = shuffleArray([...temp]);
   window.originalData = items;
   window.fullProductData = items;
