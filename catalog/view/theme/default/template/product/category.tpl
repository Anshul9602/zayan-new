...
<?php if ($product['in_wishlist']) { ?>
                                    ...
                                    <a style="position: absolute;right: 5px; padding: 12px; top: 5px;"
                                       ...
                                       btndesign="<?php echo isset($product['design_no']) ? $product['design_no'] : (isset($product['style_no']) ? $product['style_no'] : ''); ?>"
                              ...
                              <div class="product-caption">
                                 ...
                                 <?php if ($product['price']) { ?>
                                    <?php if ($product['special']) { ?>
                                       <div class="price-box">
                                          <span class="price-regular">MSRP: $<?php 
                                             $price = str_replace(['thousand_point', 'decimal_point0000'], ['', ''], $product['special']);
                                             $price = preg_replace('/[^0-9.]/', '', $price);
                                             echo number_format((float)$price, 0, '.', ',');
                                          ?></span>
                                          <span class="price-old"><del>$<?php 
                                             $price = str_replace(['thousand_point', 'decimal_point0000'], ['', ''], $product['price']);
                                             $price = preg_replace('/[^0-9.]/', '', $price);
                                             echo number_format((float)$price, 0, '.', ',');
                                          ?></del></span>
