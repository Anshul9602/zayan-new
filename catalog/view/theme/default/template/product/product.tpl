...
<script>
   ...
   document.addEventListener('DOMContentLoaded', function() {
       ...
       let priceElement = document.querySelector('#p_pr');
       if (priceElement) {
           priceElement.textContent = formatPrice(priceElement.textContent);
       }
       
       // Format special price if exists
       let specialPriceElements = document.querySelectorAll('h3 span');
       specialPriceElements.forEach(function(element) {
      ...
      <div class="col-sm-12">
         <div style="margin-bottom: 100px;" class="row">
            ...
            <div style=" text-align:left" id="product" class="col-xs-12 col-sm-5">
               ...
               <div class="row">
                        ...
                        if (!is_array($wishlist_items1_array)) {
                           $wishlist_items1_array = array();
                                    ...
                                    foreach ($wishlist_items1_array as $item) {
                                        if (is_array($item) && isset($item['productid']) && $item['productid'] == $product_id) {
                  ...
                  <div class="col-md-2">
                     ...
                     <a style="float:right;  padding:12px;    margin-top: 10px;"
                        ...
                        btnname="<?php echo htmlspecialchars($heading_title, ENT_QUOTES); ?>" btnimg="<?php echo $thumb; ?>"
                        btnhref="<?php echo $href1; ?>"
                        btnstyle="<?php echo $style_no; ?>"
                        btndesign="<?php echo $design_no; ?>"
                        btnsize="<?php echo $metal_purity; ?>"
                         btnprice="<?php echo !empty($wish_price) ? $wish_price : ''; ?>"
                         btnsiz="<?php echo isset($product_size1) ? $product_size1 : ''; ?>"
                         btnwet="<?php echo isset($wet) ? $wet : ''; ?>"
                        btnsprice="<?php echo !empty($wish_special) ? $wish_special : ''; ?>">
               ...
               <div class="product-qty" style="margin-top:20px; margin-bottom:10px;">
                  <p style="color:#000; font-size:16px; margin-bottom:8px;">Quantity</p>
                  <div class="product-qty-control" style="display:inline-flex; align-items:center; border:1px solid #333;">
                     <button type="button" class="minus-btn" id="less_quantity"
                        style="width:40px; height:40px; border:none; background:#fff; cursor:pointer; display:flex; align-items:center; justify-content:center; padding:0;">
                        <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
                        <i style="color:#333; font-size:12px;" class="fa fa-minus"></i>
                     </button>
                     <input
                        style="text-align:center; width:48px; height:40px; border:none; border-left:1px solid #333; border-right:1px solid #333; border-radius:0; box-shadow:none; background:#fff; color:#000; font-size:16px; margin:0; padding:0;"
                        type="text" readonly name="quantity" value="1" size="2" id="input-quantity"
                        class="form-control" />
                     <button type="button" class="pluse-btn" id="add_quantity"
                        style="width:40px; height:40px; border:none; background:#fff; cursor:pointer; display:flex; align-items:center; justify-content:center; padding:0;">
                        <i style="font-size:12px; color:#000;" class="fa fa-plus"></i>
                     </button>
                  </div>
               </div>
               <?php if ($options) { ?>
               ...
               <div style="padding:0px; margin-top:20px;" class="row">
                  <div style=" min-width:160px;" id="addb" class="col-sm-10">
                     <a style="width: 100%;" id="login-redirect" class="btn btn-hero" href="<?php echo isset($login) ? $login : 'index.php?route=account/login'; ?>">
                        Retailer Login</a>
                  </div>
