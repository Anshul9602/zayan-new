...
/* catalog/view/template/common/wishlist.twig */
class __TwigTemplate_f7642d75d429282cb1612fdafb0b77f138b26710b82c2aa733462232445b55e0 extends Template
{
                   ...
                   fetch(`index.php?route=common/wishlist.getProduct&product_id=\${productId}`)
                       ...
                       .then(data => {
                           ...
                           if (data.success) {
                                   ...
                                   <div class=\"card-product grid style-2\" data-product-id=\"\${product.product_id}\">
                                       ...
                                       <div class=\"card-product_info\">
                                           ...
                                           <div class=\"price-wrap\">
                                               <span class=\"price-new h6 fw-normal\">Price : \$\${product.price || '109.99'}</span>
                                           </div>
                                          </div>
                                   </div>
                               `;
                              ...
                              \$('.wrapper-wishlist').html(productHtml);
                           }
                       })
                       .catch(error => {
...
";
    ...
    {
        return "catalog/view/template/common/wishlist.twig";
    }
